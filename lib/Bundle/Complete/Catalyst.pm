package Bundle::Complete::Catalyst;
...
Bundle::Complete::Catalyst - installs all Catalyst modules

=head1 SYNOPSIS

  perl -MCPAN -e 'install Bundle::Complete::Catalyst'
...
Catalyst::Plugin::DateTime::Constructor
...
Kevin W. Henwood, <Khen1950fx at aol.com> 

=head1 COPYRIGHT & LICENSE

Copyright 2007 Kevin W. Henwood, all rights reserved.

This program is free software; you can redistribute it and/or modify it
under the same terms as Perl itself, either Perl version 5.8.8 or, at 
your option, any later version of Perl5 you may have.

=cut

1; # End of Bundle::Complete::Catalyst
